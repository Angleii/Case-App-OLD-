$(document).ready(function () {
  ...
  var right_side_views =
    ...
    '<img src="src/img/icons/siderbar-icon2.svg" class="feather-five" alt="">' +
    ...
    '<img src="src/img/logo.png" alt="Logo" class="img-flex">' +
    "</a>" +
    "</div>" +
    "</div>" +
    '<div class="col-xl-6 col-sm-6 col-12">' +
    '<a class="btn-closed" href="javascript:void(0);"><img class="img-fliud" src="src/img/icons/sidebar-delete-icon.svg" alt="demo"></a>' +
    "</div>" +
    "</div>" +
    "</div>" +
    "</div>" +
    ...
    '<img class="img-fliud" src="src/img/demo-one.png" alt="demo">' +
    "</div>" +
    '<div class="row">' +
